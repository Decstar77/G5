/* -----------------------------------------------------------------------
f * GGPO.net (http://ggpo.net)  -  Copyright 2009 GroundStorm Studios, LLC.
 *
...
#define GGPO_SPECTATOR_INPUT_INTERVAL     4
    ...
    typedef __int64 GGPOPeerHandle;
...
#define GGPO_INVALID_HANDLE      (-1)
    ...
    typedef struct {
        ...
        /*
        * local - The player handle of the local player.
        * peer - The player handle of the remote player, which the data should be sent to.
        * buffer - A pointer to a buffer containing the data to be sent.
        * len - The size of the data to be sent.
        */
        void( __cdecl * network_send_to )( GGPOPeerHandle local, GGPOPeerHandle peer, void * buffer, int len );

        /*
        * msg - The message to log
        */
        void( __cdecl * log_msg )( const char * msg );
     ...
     */
    GGPO_API GGPOErrorCode __cdecl ggpo_start_session( GGPOSession ** session, GGPOSessionCallbacks * cb,
        const char * game, int num_players, int input_size, GGPOPeerHandle local );
     ...
     */
    GGPO_API GGPOErrorCode __cdecl ggpo_set_frame_delay( GGPOSession *, GGPOPlayerHandle player, int frame_delay );
     ...
     * in milliseconds.
     */
    GGPO_API GGPOErrorCode __cdecl ggpo_idle( GGPOSession * ggpo, GGPOMessage *msgs, int num );
