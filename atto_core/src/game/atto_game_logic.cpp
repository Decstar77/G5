#include "atto_game_logic.h"

namespace atto {
    void GameLogicAndState::Start(Core* core) {
    ...
    void GameLogicAndState::UpdateAndRender(Core* core, ISimLogicAndState* sim) {
    ...
    void GameLogicAndState::Shutdown(Core* core) {
